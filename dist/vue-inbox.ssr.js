...
install$1(Vue__default["default"]);
...
function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
    ...
    /* istanbul ignore if */
    {
        Object.keys(setupStore).forEach((key) => {
            set$1(store, key, setupStore[key]);
        });
    }
...
function mapState(useStore, keysOrMapper) {
  ...
  getters: {
    requestCredentials: function requestCredentials() {
...
});var useMessageStore = defineStore('message', {
  state: function state() {
    return {
  ...
  actions: {
    loadMessages: function loadMessages(study, participant) {
      var _this = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var authStore, auth, requestParams, params, res;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                authStore = useAuthStore();
                auth = authStore.requestCredentials;
                console.log(auth);
                ...
                console.log(params);
                _context.next = 8;
                return fetch("".concat(_this.baseUrl, "/api/v2/text_messages?") + params, requestParams);
              case 8:
                res = _context.sent;
                if (res.ok) {
                  _context.next = 11;
  ...
  computed: _objectSpread2({}, mapState(useMessageStore, ['messages'])),
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _this.loading = true;
              messageStore.loadMessages(_this.studyId, _this.participantId).then(function () {
                _this.loading = false;
              });
            case 3:
            case "end":
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('div', [_vm._ssrNode("<h2>SMS Inbox</h2>" + _vm._ssrEscape("\n  " + _vm._s(_vm.loading ? 'loading' : 'done') + "\n  ") + (!_vm.loading ? "<div id=\"inbox\" style=\"min-height: 300px;border-style: solid;\">" + _vm._ssrList(_vm.messages, function (message, idx) {
    return "<span>" + _vm._ssrEscape("\n      " + _vm._s(idx) + ": " + _vm._s(message.message_text) + "\n    ") + "</span>";
  }) + "</div>" : "<!---->"))]);
};
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-0e1ea6aa_0", {
    source: ".b-overlay-wrap{min-height:150px;padding-bottom:1rem}",
    map: undefined,
    media: undefined
  });
};
...
/* module identifier */
var __vue_module_identifier__ = "data-v-0e1ea6aa";
/* functional template */
